    ...
    return (
      ...
      <main className="pt-24 flex flex-col ">
        ...
        <div  className="flex justify-center items-start relative gap-1 lg:gap-7">
          ...
          <p >At ACM SRM, we empower students with hands-on learning and exposure to the latest tech. <br /> By fostering collaboration and working on impactful projects based on Al and Blockchain, <br /> we inspire members to lead and innovate. Together, we're building tomorrow's tech <br /> leaders and changemakers.</p>
